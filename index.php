    ...
    <div class="container">
        ...
        <div class="title">
            <div class="btn-group " role="group" aria-label="Basic outlined example">
                <button id="view" type="button" class="btn btn-outline-primary">Phong cảnh</button>
                <button id="anime" type="button" class="btn btn-outline-primary">Anime</button>
                <button id="animal" type="button" class="btn btn-outline-primary">Động vật</button>
            </div>
        </div>
        <div class="data">
